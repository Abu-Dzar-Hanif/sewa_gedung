                ...
                <div class="card">
                    ...
                    <div class="table-responsive p-3">
                        <table class="table align-items-center table-flush" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                $query = mysqli_query($koneksi, "SELECT * FROM sewa inner JOIN user ON sewa.id_user = user.id_user inner JOIN gedung on gedung.id_gedung = sewa.id_gedung");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="detail_transaksi.php?id=<?php echo $data['id_sewa'] ?>" class="btn btn-sm btn-primary">Detail</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
